...
Before you read too far ahead, I recommend you download and print out a couple of copies of the 2020 Scrum Guide.
...
I'm actually not a huge fan of the way the Scrum Guide is laid out. I'm a huge fan of the wisdom it contains, but not a fan of the way it's structured.

For example, the first paragraph in the Scrum Guide talks about the Product Owner and Product Backlog items. Yet the Scrum Guide itself doesn't explain what a Product Owner or a Product Backlog item is for another five or six pages.  
...
To be successful on the Scrum Master Certification exam, you have to commit to the Scrum Guide's definition of Scrum. This means abandoning many biases and misconceptions you may have adopted over years of hearing people talk about Scrum or seeing Scrum implemented in a less than pure manner.

Here is the 2020 Scrum Guide's first sentence. How well does this definition of Scrum work with the way you previously perceived it? (And I say 'previously', because this is the definition you must 100% commit to right now if you want to pass the Scrum Master certification exam.)
