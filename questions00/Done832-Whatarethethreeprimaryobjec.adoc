...
[#list]
--
* [*] A. The DoD help the Development Team estimate the number of Product Backlog items to select for the Sprint
...
"If there are multiple Scrum Teams working together on a product, they must mutually define and comply with the same Definition of Done." - The Scrum Guide, page 12.
