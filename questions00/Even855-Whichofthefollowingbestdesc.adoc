...
id: 855-63effb129ebbe935e4c16aab.
---
...
* [ ] B. The Sprint Review is a demo developers do for stakeholders at the end of the Sprint.
...
* [*] D. The Sprint Review is an opportunity for the Scrum Team and stakeholders inspect the additive product Increment and think of ways to adapt for the future.
