---
layout: default 
title: "860 - Which three of the following are timebox"
id: 860-63effbdd9ebbe935e4c16ac7.
---
...
Sprint Review: This is a time-boxed event that takes place at the end of each Sprint. The purpose of the Sprint Review is to review the work that was completed during the Sprint and to gather feedback from stakeholders. The Development Team shares their work to the stakeholders, and the stakeholders provide feedback that can be used to refine the Product Backlog. The time-box for the Sprint Review is typically 4 hours for a one-month Sprint.
