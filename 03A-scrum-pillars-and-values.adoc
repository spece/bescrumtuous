...
'Scrum values' is one of the 13 categories upon which your Scrum Certification exam is graded. It's an important topic.
...
We've already seen a reference to the Scrum Pillars in the Guide:
