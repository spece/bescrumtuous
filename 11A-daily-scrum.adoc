...
Scrum isn't some framework that _demands_ developers use some crazy set of new and revolutionary techniques. All Scrum really does is document the practices good development teams already do.
...
The Daily Scrum simply puts a little bit of ceremony and formality around the natural fact that developers generally talk to each other when they get together at the start of the workday. 
